...
OP_DESCRIPTIONS = {
    ...
    "optimize_design_depth": "Run conservative design-depth optimization. Args: optional max_depth, cost_function, cost_scope, allowed_gates, constraints, objective. When the prompt says final design maximum logic depth or says smaller logic depth is better, use cost_function=\"max_logic_depth\", objective=\"minimize\", and cost_scope=\"whole_design\". Put only named-signal cone gate-library limits in constraints, e.g. [{\"type\":\"cone_gate_library\",\"target\":\"n10\",\"allowed_gates\":[\"nor\",\"not\"]}]. Never use target \"whole_design\", \"design\", or \"netlist\" in a cone_gate_library constraint; for whole-design gate-library rewrites, use an explicit whole-design rewrite operation such as replace_with_and_not before optimize_design_depth.",
